      ...
      <div className="Contenitore mb-3">
        <div className="text-center">
          ...
          <Row className="fs-7 border-bottom pb-1">
            ...
            <Link className="mt-1" to="/me">
              Aggiungi una foto
            </Link>
          </Row>
        </div>
        <Row className="py-2 collegamenti border-bottom position-relative">
          <Col xs={12} className="fs-7">
            <p className="mb-0 text-muted">Collegamenti</p>
            <p className="mb-0 bold">Espandi la tua rete</p>
          </Col>
          <Col xs={1} className="addPeople me-2">
            <BsFillPersonPlusFill />
          </Col>
        </Row>
        ...
        <Col className="d-flex gap-1 align-items-center py-2">
          <BsFillBookmarkFill /> <span className="fs-7">I miei elementi</span>
        </Col>
      </div>
    </>
  );
