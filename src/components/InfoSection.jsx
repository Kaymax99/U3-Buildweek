            ...
            {profile?.name ? (
              <>
                ...
                <div className="m-3">
                  ...
                  {params.profileID === "me" ? (
                    <>
                      <Button variant="primary rounded-pill py-1 px-3 my-1 fw-bold me-2 fs-7">
                        Disponibile per
                      </Button>
                      <Button variant="outline-primary rounded-pill py-1 px-3 my-1 fw-bold me-2 fs-7">
                        Aggiungi sezione del profilo
                      </Button>
                    </>
                  ) : (
                  ...
                  <Button variant="outline-secondary rounded-pill py-0 px-1 py-md-1 px-md-3 my-1 fw-bold fs-7">
                    <span className="d-none d-md-inline">Altro</span>{" "}
                    <ThreeDots className="d-md-none mb-1" />
                  </Button>
                </div>
